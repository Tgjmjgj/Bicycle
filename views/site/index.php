                            ...
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
                                        ...
                                        <h2>
										<!--<?php echo $product['price']; ?><label style="color: orange; font-size: 25px; font-family: times new roman; margin-left: 5px" >бел. руб.</label></h2>-->
                                        <?php echo $product['price']; ?> бел. руб.</h2>
										<p>
